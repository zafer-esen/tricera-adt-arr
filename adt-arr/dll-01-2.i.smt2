...
(assert (forall ((var0 Addr) (var1 Heap)) (or (not (and (inv_main3 var1 var0) (is-O_TSLL (read var1 var0)))) (inv_main4 (write var1 var0 (O_TSLL (TSLL nullAddr (prev (getTSLL (read var1 var0))) (inner (getTSLL (read var1 var0)))))) var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main4 var3 var2) (and (and (= var1 nullAddr) (is-O_TSLL (read var3 var2))) (and (= var0 (write var3 var2 (O_TSLL (TSLL (next (getTSLL (read var3 var2))) nullAddr (inner (getTSLL (read var3 var2))))))) (= var1 var2))))) (inv_main8 var0 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main16 var2 var1 var0) (is-O_TSLL (read var2 var1)))) (inv_main15 (write var2 var1 (O_TSLL (TSLL (next (getTSLL (read var2 var1))) (prev (getTSLL (read var2 var1))) var0))) var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main51 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (is-O_TSLL (read var2 (inner (getTSLL (read var2 var0)))))))) (inv_main53 (write var2 (inner (getTSLL (read var2 var0))) (O_TSLL (TSLL nullAddr (prev (getTSLL (read var2 (inner (getTSLL (read var2 var0)))))) (inner (getTSLL (read var2 (inner (getTSLL (read var2 var0))))))))) var1 var0))))
(assert (forall ((var0 Addr) (var1 Heap)) (or (not (and (inv_main15 var1 var0) (and (is-O_TSLL (read var1 var0)) (is-O_TSLL (read var1 (inner (getTSLL (read var1 var0)))))))) (inv_main17 (write var1 (inner (getTSLL (read var1 var0))) (O_TSLL (TSLL nullAddr (prev (getTSLL (read var1 (inner (getTSLL (read var1 var0)))))) (inner (getTSLL (read var1 (inner (getTSLL (read var1 var0))))))))) var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main31 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (is-O_TSLL (read var2 (next (getTSLL (read var2 var0)))))))) (inv_main33 (write var2 (next (getTSLL (read var2 var0))) (O_TSLL (TSLL (next (getTSLL (read var2 (next (getTSLL (read var2 var0)))))) var0 (inner (getTSLL (read var2 (next (getTSLL (read var2 var0))))))))) var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main122 var2 var1 var0) (is-O_TSLL (read var2 var1)))) (inv_main104 (write var2 var1 (O_TSLL (TSLL (next (getTSLL (read var2 var1))) (prev (getTSLL (read var2 var1))) nullAddr))) var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Heap)) (or (not (and (inv_main12 var1 var0) (is-O_TSLL (read var1 var0)))) (inv_main11 (write var1 var0 (O_TSLL (TSLL (next (getTSLL (read var1 var0))) (prev (getTSLL (read var1 var0))) nullAddr))) var0))))
(assert (forall ((var0 Addr) (var1 Heap)) (or (not (and (inv_main17 var1 var0) (and (is-O_TSLL (read var1 var0)) (is-O_TSLL (read var1 (inner (getTSLL (read var1 var0)))))))) (inv_main11 (write var1 (inner (getTSLL (read var1 var0))) (O_TSLL (TSLL (next (getTSLL (read var1 (inner (getTSLL (read var1 var0)))))) (prev (getTSLL (read var1 (inner (getTSLL (read var1 var0)))))) nullAddr))) var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main48 var2 var1 var0) (is-O_TSLL (read var2 var0)))) (inv_main47 (write var2 var0 (O_TSLL (TSLL (next (getTSLL (read var2 var0))) (prev (getTSLL (read var2 var0))) nullAddr))) var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main53 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (is-O_TSLL (read var2 (inner (getTSLL (read var2 var0)))))))) (inv_main47 (write var2 (inner (getTSLL (read var2 var0))) (O_TSLL (TSLL (next (getTSLL (read var2 (inner (getTSLL (read var2 var0)))))) (prev (getTSLL (read var2 (inner (getTSLL (read var2 var0)))))) nullAddr))) var1 var0))))
...
(assert (forall ((var0 TSLL) (var1 Heap) (var2 Addr) (var3 Int) (var4 Addr) (var5 Heap)) (or (not (and (inv_main4 var5 var4) (and (= var3 0) (and (and (not (= var2 nullAddr)) (is-O_TSLL (read var5 var4))) (and (= var1 (write var5 var4 (O_TSLL (TSLL (next (getTSLL (read var5 var4))) nullAddr (inner (getTSLL (read var5 var4))))))) (= var2 var4)))))) (inv_main16 (newHeap (alloc var1 (O_TSLL var0))) var2 (newAddr (alloc var1 (O_TSLL var0)))))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Int) (var3 Addr) (var4 Heap)) (or (not (and (inv_main4 var4 var3) (and (not (= var2 0)) (and (and (not (= var1 nullAddr)) (is-O_TSLL (read var4 var3))) (and (= var0 (write var4 var3 (O_TSLL (TSLL (next (getTSLL (read var4 var3))) nullAddr (inner (getTSLL (read var4 var3))))))) (= var1 var3)))))) (inv_main12 var0 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main32 var3 var2 var1 var0) (is-O_TSLL (read var3 var1)))) (inv_main31 (write var3 var1 (O_TSLL (TSLL var0 (prev (getTSLL (read var3 var1))) (inner (getTSLL (read var3 var1)))))) var2 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main52 var3 var2 var1 var0) (is-O_TSLL (read var3 var1)))) (inv_main51 (write var3 var1 (O_TSLL (TSLL (next (getTSLL (read var3 var1))) (prev (getTSLL (read var3 var1))) var0))) var2 var1))))

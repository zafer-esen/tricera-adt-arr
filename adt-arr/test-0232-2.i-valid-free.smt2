...
(declare-fun inv_main550_9 (Heap Addr Addr) Bool)
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main550_9 var2 var1 var0) (and (not (= var1 nullAddr)) (= (read var2 var1) defObj))))))
(check-sat)

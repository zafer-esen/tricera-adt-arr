...
(declare-fun inv_main_25 (Heap Int Int Addr Int Addr) Bool)
(declare-fun inv_main_31 (Heap Int Int Addr Int Addr) Bool)
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (or (not (and (inv_main604_3 var5 var4 var3 var2 var1 var0) (not (= var3 (|node::data| (getnode (read var5 var0))))))) (inv_main_31 var5 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Addr) (var4 Int) (var5 Int) (var6 Heap)) (or (not (and (inv_main_25 var6 var5 var4 var3 var2 var1) (and (not (= (+ var2 (- 1)) (|node::data| (getnode (read var6 var1))))) (= var0 (+ var2 (- 1)))))) (inv_main_31 var6 var5 var4 var3 var0 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Addr) (var4 Int) (var5 Int) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Int) (var10 Addr) (var11 Int) (var12 Int) (var13 Heap) (var14 Addr) (var15 Addr) (var16 Addr) (var17 Int) (var18 Int) (var19 Addr) (var20 Addr) (var21 Int) (var22 Int) (var23 Int) (var24 Int) (var25 Heap) (var26 Heap) (var27 Addr) (var28 Int) (var29 Addr) (var30 Int) (var31 Int) (var32 Heap)) (or (not (and (inv_main604_3 var32 var31 var30 var29 var28 var27) (and (and (and (and (and (and (and (and (and (= var26 var25) (= var24 var23)) (= var22 var21)) (= var20 var19)) (= var18 (+ var17 1))) (= var16 var15)) (= var14 (|node::prev| (getnode (read var25 var15))))) (and (= var15 var19) (and (and (and (and (and (and (and (and (= var25 var13) (= var23 var12)) (= var21 var11)) (= var19 var10)) (= var17 var9)) (= var8 var7)) (= var15 (|node::next| (getnode (read var13 var7))))) (= var30 (|node::data| (getnode (read var32 var27))))) (and (and (and (and (and (= var13 (write var32 var27 (O_node (node var28 (|node::next| (getnode (read var32 var27))) (|node::prev| (getnode (read var32 var27))))))) (= var12 var31)) (= var11 var30)) (= var10 var29)) (= var9 var28)) (= var7 var27))))) (and (and (and (and (and (= var6 (write var26 var20 (O_node (node (|node::data| (getnode (read var26 var20))) (|node::next| (getnode (read var26 var20))) nullAddr)))) (= var5 var24)) (= var4 var22)) (= var3 var20)) (= var2 var18)) (= var1 var14))) (= var0 nullAddr)))) (inv_main_25 var6 var5 var4 var0 var2 var1))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Int) (var9 Addr) (var10 Int) (var11 Int) (var12 Heap) (var13 Addr) (var14 Addr) (var15 Int) (var16 Addr) (var17 Int) (var18 Int) (var19 Heap)) (or (not (and (inv_main_25 var19 var18 var17 var16 var15 var14) (and (not (= var13 nullAddr)) (and (and (and (and (and (and (and (and (= var12 var19) (= var11 var18)) (= var10 var17)) (= var9 var16)) (= var8 (+ var15 (- 1)))) (= var7 var14)) (= var6 (|node::prev| (getnode (read var19 var14))))) (and (and (and (and (and (and (= var5 (write var12 var7 defObj)) (= var4 var11)) (= var3 var10)) (= var2 var9)) (= var1 var8)) (= var0 var7)) (= var13 var6))) (= (+ var15 (- 1)) (|node::data| (getnode (read var19 var14)))))))) (inv_main_25 var5 var4 var3 var2 var1 var13))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Addr) (var6 Int) (var7 Int) (var8 Int) (var9 Int) (var10 Heap) (var11 Heap) (var12 Addr) (var13 Addr) (var14 Addr) (var15 Int) (var16 Addr) (var17 Int) (var18 Int) (var19 Heap)) (or (not (and (inv_main604_3 var19 var18 var17 var16 var15 var14) (and (and (not (= var13 var12)) (and (and (and (and (and (and (and (and (= var11 var10) (= var9 var8)) (= var7 var6)) (= var12 var5)) (= var4 var3)) (= var2 var1)) (= var13 (|node::next| (getnode (read var10 var1))))) (= var17 (|node::data| (getnode (read var19 var14))))) (and (and (and (and (and (= var10 (write var19 var14 (O_node (node var15 (|node::next| (getnode (read var19 var14))) (|node::prev| (getnode (read var19 var14))))))) (= var8 var18)) (= var6 var17)) (= var5 var16)) (= var3 var15)) (= var1 var14)))) (= var0 (+ var4 1))))) (inv_main604_3 var11 var9 var7 var12 var0 var13))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (not (inv_main_31 var5 var4 var3 var2 var1 var0))))
(check-sat)

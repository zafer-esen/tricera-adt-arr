...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (or (not (and (inv_main600_3 var5 var4 var3 var2 var1 var0) (not (= var3 (|node::data| (getnode (read var5 var0))))))) (inv_main_28 var5 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (or (not (and (inv_main_20 var5 var4 var3 var2 var1 var0) (not (= var1 (|node::data| (getnode (read var5 var0))))))) (inv_main_28 var5 var4 var3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Int) (var4 Int) (var5 Heap) (var6 Addr) (var7 Int) (var8 Int) (var9 Int) (var10 Heap) (var11 Addr) (var12 Addr) (var13 Addr) (var14 Addr) (var15 Addr) (var16 Int) (var17 Addr) (var18 Int) (var19 Int) (var20 Heap)) (or (not (and (inv_main_20 var20 var19 var18 var17 var16 var15) (and (and (not (= var14 var13)) (and (and (and (not (= var12 var11)) (and (and (and (and (and (and (= var10 var20) (= var9 var19)) (= var8 var18)) (= var11 var17)) (= var7 var16)) (= var12 var15)) (= var6 (|node::next| (getnode (read var20 var15)))))) (and (and (and (and (and (and (= var5 (write var10 var12 defObj)) (= var4 var9)) (= var3 var8)) (= var13 var11)) (= var2 var7)) (= var1 var12)) (= var14 var6))) (= var16 (|node::data| (getnode (read var20 var15)))))) (= var0 (+ var2 1))))) (inv_main_20 var5 var4 var3 var13 var0 var14))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (not (inv_main_28 var5 var4 var3 var2 var1 var0))))
(check-sat)

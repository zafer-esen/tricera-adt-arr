...
(declare-fun inv_main614_3 (Heap Addr Int Int) Bool)
(declare-fun inv_main616_7 (Heap Addr Int Int Addr Int) Bool)
(declare-fun inv_main624_10 (Heap Addr Int) Bool)
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Heap)) (or (not (and (and (and (= var3 emptyHeap) (= var2 nullAddr)) (= var1 2)) (= var0 1))) (inv_main614_3 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Addr) (var4 Int) (var5 Int) (var6 Addr) (var7 Heap) (var8 Addr) (var9 Addr) (var10 Addr) (var11 Int) (var12 Int) (var13 Int) (var14 Int) (var15 Addr) (var16 Int) (var17 Int) (var18 Int) (var19 Int) (var20 Addr) (var21 Addr) (var22 Addr) (var23 Heap) (var24 Heap) (var25 Int) (var26 Addr) (var27 Int) (var28 Int) (var29 Addr) (var30 Heap)) (or (not (and (inv_main616_7 var30 var29 var28 var27 var26 var25) (and (and (and (and (and (and (and (and (and (and (and (= var24 (write var23 var22 defObj)) (or (and (= var20 var22) (= var21 nullAddr)) (and (not (= var20 var22)) (= var21 var20)))) (= var19 var18)) (= var17 var16)) (= var15 var22)) (= var14 var13)) (= var12 var11)) (= var10 var9)) (and (not (= var8 nullAddr)) (and (and (and (and (and (and (and (= var7 var30) (= var6 var29)) (= var5 var28)) (= var4 var27)) (= var3 var26)) (= var2 var25)) (= var1 4)) (= var8 (|node::next| (getnode (read var30 var26))))))) (and (and (and (and (and (and (and (= var23 (write var7 var8 (O_node (node (|node::data| (getnode (read var7 var8))) (|node::next| (getnode (read var7 var8))) nullAddr)))) (= var20 var6)) (= var18 var5)) (= var16 var4)) (= var22 var3)) (= var13 var2)) (= var11 var1)) (= var9 var8))) (<= 0 var25)) (= var0 (+ var14 (- 1)))))) (inv_main616_7 var24 var21 var19 var17 var10 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Int) (var6 Int) (var7 Addr) (var8 Int) (var9 Int) (var10 Int) (var11 Int) (var12 Addr) (var13 Addr) (var14 Addr) (var15 Heap) (var16 Heap) (var17 Int) (var18 Addr) (var19 Int) (var20 Int) (var21 Addr) (var22 Heap)) (or (not (and (inv_main616_7 var22 var21 var20 var19 var18 var17) (and (and (and (and (and (and (and (and (and (and (= var16 (write var15 var14 defObj)) (or (and (= var12 var14) (= var13 nullAddr)) (and (not (= var12 var14)) (= var13 var12)))) (= var11 var10)) (= var9 var8)) (= var7 var14)) (= var6 var5)) (= var4 var3)) (= var2 var1)) (and (= var1 nullAddr) (and (and (and (and (and (and (and (= var15 var22) (= var12 var21)) (= var10 var20)) (= var8 var19)) (= var14 var18)) (= var5 var17)) (= var3 4)) (= var1 (|node::next| (getnode (read var22 var18))))))) (<= 0 var17)) (= var0 (+ var6 (- 1)))))) (inv_main616_7 var16 var13 var11 var9 var2 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Int) (var4 Int) (var5 Int) (var6 Addr) (var7 Heap)) (or (not (and (inv_main586_3 var7 var6 var5 var4 var3 var2 var1) (and (not (<= 0 (+ var3 (- 1)))) (= var0 (+ var5 (- 1)))))) (inv_main616_7 var7 var6 var5 var4 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Addr) (var4 Heap)) (or (not (and (inv_main614_3 var4 var3 var2 var1) (= var0 nullAddr))) (inv_main586_3 var4 var3 var2 var1 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Int) (var4 Addr) (var5 Heap)) (or (not (and (inv_main616_7 var5 var4 var3 var2 var1 var0) (and (not (= nullAddr var1)) (not (<= 0 var0))))) (inv_exit var5 var4))))
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Int) (var4 Int) (var5 Addr) (var6 Heap)) (or (not (and (inv_main616_7 var6 var5 var4 var3 var2 var1) (and (and (= nullAddr var2) (not (<= 0 var1))) (= var0 0)))) (inv_main624_10 var6 var5 var0))))

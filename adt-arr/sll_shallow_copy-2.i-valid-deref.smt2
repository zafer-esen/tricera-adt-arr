...
(assert (forall ((var0 node) (var1 Addr) (var2 Heap)) (or (not (and (inv_main_3 var2 var1) (and (and (is-O_node (read var2 var1)) (is-O_node (read var2 (|node::next| (getnode (read var2 var1)))))) (= var0 (getnode (read var2 (|node::next| (getnode (read var2 var1))))))))) (inv_main571_3 var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Heap)) (not (and (inv_main_3 var1 var0) (and (is-O_node (read var1 var0)) (not (is-O_node (read var1 (|node::next| (getnode (read var1 var0)))))))))))

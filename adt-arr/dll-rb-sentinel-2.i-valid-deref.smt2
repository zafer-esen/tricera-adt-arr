...
(declare-fun inv_main1011_2 (Heap Addr Addr) Bool)
(declare-fun inv_main1022_3 (Heap Addr Addr Addr Addr) Bool)
(declare-fun inv_main1028_3 (Heap Addr Addr Addr) Bool)
(declare-fun inv_main1032_3 (Heap Addr Addr Addr) Bool)
(declare-fun inv_main1034_4 (Heap Addr Addr Addr Addr) Bool)
(declare-fun inv_main1053_7 (Heap Addr Addr Addr) Bool)
(declare-fun inv_main1067_3 (Heap Addr Addr Addr) Bool)
(declare-fun inv_main1074_3 (Heap Addr Addr Addr) Bool)
...
(assert (forall ((var0 Addr) (var1 Heap) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Addr) (var10 Addr) (var11 Addr) (var12 Heap)) (or (not (and (inv_main1074_3 var12 var11 var10 var9) (and (not (= var8 var7)) (and (and (is-O_TSLL (read var12 var10)) (and (and (and (and (= var6 var12) (= var5 var11)) (= var4 var10)) (= var3 var9)) (= var2 (|TSLL::next| (getTSLL (read var12 var10)))))) (and (and (and (= var1 (write var6 var4 defObj)) (= var8 var5)) (= var0 var4)) (= var7 var2)))))) (inv_main_46 var1 var8 var7 var7))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main1028_3 var4 var3 var2 var1) (and (and (is-O_TSLL (read var4 var1)) (is-O_TSLL (read var4 var1))) (= var0 (write var4 var1 (O_TSLL (TSLL (|TSLL::next| (getTSLL (read var4 var1))) (|TSLL::prev| (getTSLL (read var4 var1))) 1))))))) (inv_main_13 var0 var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main_36 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var0)) (= 0 (|TSLL::colour| (getTSLL (read var3 var0))))))) (inv_main1053_7 var3 var2 var1 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main1011_2 var3 var2 var1) (and (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))) (= var0 (write var3 var1 (O_TSLL (TSLL var2 (|TSLL::prev| (getTSLL (read var3 var1))) (|TSLL::colour| (getTSLL (read var3 var1)))))))))) (inv_main_4 var0 var2 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main_11 var8 var7 var6 var5) (and (= var4 0) (and (and (is-O_TSLL (read var8 var5)) (is-O_TSLL (read var8 var5))) (and (and (and (= var3 (write var8 var5 (O_TSLL (TSLL var7 (|TSLL::prev| (getTSLL (read var8 var5))) (|TSLL::colour| (getTSLL (read var8 var5))))))) (= var2 var7)) (= var1 var6)) (= var0 var5)))))) (inv_main1032_3 var3 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main_46 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var1)) (not (= 0 (|TSLL::colour| (getTSLL (read var3 var1)))))))) (inv_main1074_3 var3 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main1053_7 var8 var7 var6 var5) (and (not (= var4 var3)) (and (is-O_TSLL (read var8 var5)) (and (and (and (and (= var2 var8) (= var4 var7)) (= var1 var6)) (= var0 var5)) (= var3 (|TSLL::next| (getTSLL (read var8 var5))))))))) (inv_main_40 var2 var4 var1 var3))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main1022_3 var5 var4 var3 var2 var1) (and (and (is-O_TSLL (read var5 var2)) (is-O_TSLL (read var5 var2))) (= var0 (write var5 var2 (O_TSLL (TSLL var1 (|TSLL::prev| (getTSLL (read var5 var2))) (|TSLL::colour| (getTSLL (read var5 var2)))))))))) (inv_main_9 var0 var4 var3 var2))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main1034_4 var5 var4 var3 var2 var1) (and (and (is-O_TSLL (read var5 var2)) (is-O_TSLL (read var5 var2))) (= var0 (write var5 var2 (O_TSLL (TSLL var1 (|TSLL::prev| (getTSLL (read var5 var2))) (|TSLL::colour| (getTSLL (read var5 var2)))))))))) (inv_main_15 var0 var4 var3 var2))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (inv_main1067_3 var9 var8 var7 var6) (and (and (is-O_TSLL (read var9 var7)) (and (and (and (and (= var5 var9) (= var4 var8)) (= var3 var7)) (= var2 var6)) (= var1 (|TSLL::next| (getTSLL (read var9 var7)))))) (= var0 (write var5 var3 defObj))))) (inv_main_48 var0 var4 var3 var1))))
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_2 var6 var5) (and (and (and (and (is-O_TSLL (read var6 var5)) (is-O_TSLL (read var6 var5))) (and (= var4 (write var6 var5 (O_TSLL (TSLL (|TSLL::next| (getTSLL (read var6 var5))) (|TSLL::prev| (getTSLL (read var6 var5))) 1)))) (= var3 var5))) (= var2 (newHeap (alloc var4 (O_TSLL var1))))) (= var0 (newAddr (alloc var4 (O_TSLL var1))))))) (inv_main1011_2 var2 var3 var0))))
...
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Addr) (var10 Heap)) (or (not (and (inv_main1032_3 var10 var9 var8 var7) (and (and (and (and (is-O_TSLL (read var10 var7)) (is-O_TSLL (read var10 var7))) (and (and (and (= var6 (write var10 var7 (O_TSLL (TSLL (|TSLL::next| (getTSLL (read var10 var7))) (|TSLL::prev| (getTSLL (read var10 var7))) 0)))) (= var5 var9)) (= var4 var8)) (= var3 var7))) (= var2 (newHeap (alloc var6 (O_TSLL var1))))) (= var0 (newAddr (alloc var6 (O_TSLL var1))))))) (inv_main1034_4 var2 var5 var4 var3 var0))))
...
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Int) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (inv_main_19 var7 var6 var5 var4) (and (and (and (not (= var3 0)) (and (not (= var6 var4)) (and (is-O_TSLL (read var7 var4)) (= var6 (|TSLL::next| (getTSLL (read var7 var4))))))) (= var2 (newHeap (alloc var7 (O_TSLL var1))))) (= var0 (newAddr (alloc var7 (O_TSLL var1))))))) (inv_main1022_3 var2 var6 var5 var4 var0))))
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap) (var6 Int) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (inv_main_5 var9 var8 var7) (and (and (and (not (= var6 0)) (and (and (is-O_TSLL (read var9 var7)) (is-O_TSLL (read var9 var7))) (and (and (= var5 (write var9 var7 (O_TSLL (TSLL (|TSLL::next| (getTSLL (read var9 var7))) (|TSLL::prev| (getTSLL (read var9 var7))) 1)))) (= var4 var8)) (= var3 var7)))) (= var2 (newHeap (alloc var5 (O_TSLL var1))))) (= var0 (newAddr (alloc var5 (O_TSLL var1))))))) (inv_main1022_3 var2 var4 var3 var3 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Heap)) (or (not (and (inv_main1006_2_1 var2 var1) (and (and (is-O_TSLL (read var2 var1)) (is-O_TSLL (read var2 var1))) (= var0 (write var2 var1 (O_TSLL (TSLL nullAddr (|TSLL::prev| (getTSLL (read var2 var1))) (|TSLL::colour| (getTSLL (read var2 var1)))))))))) (inv_main var0 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main_46 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var1)) (= 0 (|TSLL::colour| (getTSLL (read var3 var1))))))) (inv_main1067_3 var3 var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main_40 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var0)) (= 1 (|TSLL::colour| (getTSLL (read var3 var0))))))) (inv_main_37 var3 var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main1011_2 var2 var1 var0) (not (is-O_TSLL (read var2 var0)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main1011_2 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (not (is-O_TSLL (read var2 var0))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (not (and (inv_main1022_3 var4 var3 var2 var1 var0) (not (is-O_TSLL (read var4 var1)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (not (and (inv_main1022_3 var4 var3 var2 var1 var0) (and (is-O_TSLL (read var4 var1)) (not (is-O_TSLL (read var4 var1))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main1032_3 var3 var2 var1 var0) (not (is-O_TSLL (read var3 var0)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main1032_3 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var0)) (not (is-O_TSLL (read var3 var0))))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (not (and (inv_main1034_4 var4 var3 var2 var1 var0) (not (is-O_TSLL (read var4 var1)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (not (and (inv_main1034_4 var4 var3 var2 var1 var0) (and (is-O_TSLL (read var4 var1)) (not (is-O_TSLL (read var4 var1))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main1053_7 var3 var2 var1 var0) (not (is-O_TSLL (read var3 var0)))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main1074_3 var3 var2 var1 var0) (not (is-O_TSLL (read var3 var1)))))))
(check-sat)

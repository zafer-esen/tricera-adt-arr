...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main_14 var3 var2 var1 var0) (and (not (= 1 (|TSLL::data| (getTSLL (read var3 var0))))) (= 1 (|TSLL::data| (getTSLL (read var3 var0))))))) (inv_exit var3 var2))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main_14 var8 var7 var6 var5) (and (not (= 2 (|TSLL::data| (getTSLL (read var4 var3))))) (and (and (and (and (and (= var4 var8) (= var2 var7)) (= var1 var6)) (= var0 var5)) (= var3 (|TSLL::next| (getTSLL (read var8 var5))))) (and (= 1 (|TSLL::data| (getTSLL (read var8 var5)))) (= 1 (|TSLL::data| (getTSLL (read var8 var5))))))))) (inv_exit var4 var2))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main_14 var8 var7 var6 var5) (and (= 2 (|TSLL::data| (getTSLL (read var4 var3)))) (and (and (and (and (and (= var4 var8) (= var2 var7)) (= var1 var6)) (= var0 var5)) (= var3 (|TSLL::next| (getTSLL (read var8 var5))))) (and (= 1 (|TSLL::data| (getTSLL (read var8 var5)))) (= 1 (|TSLL::data| (getTSLL (read var8 var5))))))))) (inv_main_29 var4 var2 var1 var1))))

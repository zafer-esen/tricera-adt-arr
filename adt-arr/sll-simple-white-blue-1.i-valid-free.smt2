...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (inv_main_35 var9 var8 var7) (and (and (and (and (and (= var6 var5) (= var4 var3)) (= var2 var3)) (= var1 (|TSLL::next| (getTSLL (read var5 var3))))) (not (= var3 nullAddr))) (and (and (= var5 (write var9 var8 defObj)) (= var0 var8)) (= var3 var7))))) (inv_main_35 var6 var4 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_23 var6 var5 var4) (and (and (and (and (and (= var3 var6) (= var2 var5)) (= var1 var5)) (= var0 (|TSLL::next| (getTSLL (read var6 var5))))) (not (= var5 nullAddr))) (= var4 nullAddr)))) (inv_main_35 var3 var2 var0))))

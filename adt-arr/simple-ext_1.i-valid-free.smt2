...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap) (var6 Int) (var7 Addr) (var8 Addr) (var9 Addr) (var10 Heap)) (or (not (and (inv_main_16 var10 var9 var8 var7 var6) (and (and (and (and (and (and (and (= var5 var10) (= var4 var9)) (= var3 var8)) (= var2 var9)) (= var1 var6)) (= var0 (|node::n| (getnode (read var10 var9))))) (not (= var9 nullAddr))) (= var7 nullAddr)))) (inv_main_27 var5 var4 var0 var2 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Int) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Heap) (var10 Heap) (var11 Int) (var12 Addr) (var13 Addr) (var14 Addr) (var15 Heap)) (or (not (and (inv_main_27 var15 var14 var13 var12 var11) (and (and (and (and (and (and (and (= var10 var9) (= var8 var7)) (= var6 var5)) (= var4 var5)) (= var3 var2)) (= var1 (|node::n| (getnode (read var9 var5))))) (not (= var5 nullAddr))) (and (and (and (and (= var9 (write var15 var12 defObj)) (= var7 var14)) (= var5 var13)) (= var0 var12)) (= var2 var11))))) (inv_main_27 var10 var8 var1 var4 var3))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (not (and (inv_main_27 var4 var3 var2 var1 var0) (and (not (= var1 nullAddr)) (= (read var4 var1) defObj))))))
(check-sat)

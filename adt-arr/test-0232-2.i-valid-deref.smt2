...
(assert (forall ((var0 Addr) (var1 Heap) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (inv_main_10 var7 var6) (and (not (= var5 nullAddr)) (and (and (is-O_item (read var7 var6)) (and (and (= var4 var7) (= var3 var6)) (= var2 (|item::next| (getitem (read var7 var6)))))) (and (and (= var1 (write var4 var3 defObj)) (= var0 var3)) (= var5 var2)))))) (inv_main_10 var1 var5))))

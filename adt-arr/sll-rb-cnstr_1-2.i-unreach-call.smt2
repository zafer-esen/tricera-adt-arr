...
(declare-fun inv_main1049_12 (Heap Addr Addr) Bool)
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main_17 var2 var1 var0) (and (= (|TSLL::next| (getTSLL (read var2 var0))) nullAddr) (and (not (= 0 (|TSLL::colour| (getTSLL (read var2 var0))))) (not (= nullAddr var0)))))) (inv_main1049_12 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap) (var6 Addr) (var7 Heap) (var8 Addr) (var9 Addr) (var10 Heap)) (or (not (and (inv_main_17 var10 var9 var8) (and (= (|TSLL::next| (getTSLL (read var7 var6))) nullAddr) (and (and (and (and (= var7 var5) (= var4 var3)) (= var2 var1)) (= var6 (|TSLL::next| (getTSLL (read var5 var1))))) (and (and (and (and (= var5 var10) (= var3 var9)) (= var0 var8)) (= var1 (|TSLL::next| (getTSLL (read var10 var8))))) (and (= 0 (|TSLL::colour| (getTSLL (read var10 var8)))) (not (= nullAddr var8)))))))) (inv_main1049_12 var7 var4 var6))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (inv_main1049_12 var2 var1 var0))))
(check-sat)

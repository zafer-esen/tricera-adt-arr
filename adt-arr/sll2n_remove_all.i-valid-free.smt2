...
(declare-fun inv_main593_3 (Heap Int Int Addr Int Int Addr) Bool)
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Addr) (var4 Int) (var5 Addr) (var6 Int) (var7 Int) (var8 Heap) (var9 Int) (var10 Addr) (var11 Int) (var12 Int) (var13 Addr) (var14 Int) (var15 Int) (var16 Heap)) (or (not (and (inv_main593_3 var16 var15 var14 var13 var12 var11 var10) (and (and (and (and (<= 0 (+ var9 (- 1))) (and (and (and (and (and (and (= var8 (write var16 var13 defObj)) (= var7 var15)) (= var6 var14)) (= var5 var13)) (= var9 var12)) (= var4 var11)) (= var3 var10))) (= var2 (+ var9 (- 1)))) (= var1 3)) (= var0 (|node::next| (getnode (read var8 var3))))))) (inv_main593_3 var8 var7 var6 var3 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Addr) (var4 Int) (var5 Int) (var6 Int) (var7 Int) (var8 Heap)) (or (not (and (inv_main585_7 var8 var7 var6 var5 var4 var3) (and (and (and (and (<= 0 (+ var7 (- 1))) (not (<= 0 (+ var5 (- 1))))) (= var2 (+ var7 (- 1)))) (= var1 3)) (= var0 (|node::next| (getnode (read var8 var3))))))) (inv_main593_3 var8 var7 var6 var3 var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Addr) (var4 Int) (var5 Int) (var6 Heap)) (not (and (inv_main593_3 var6 var5 var4 var3 var2 var1 var0) (and (not (= var3 nullAddr)) (= (read var6 var3) defObj))))))
(check-sat)

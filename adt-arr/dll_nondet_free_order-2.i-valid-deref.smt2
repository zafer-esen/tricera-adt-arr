...
(declare-fun inv_main619_3 (Heap Int Addr Addr) Bool)
...
(assert (forall ((var0 Int) (var1 Int) (var2 node) (var3 Heap) (var4 Addr) (var5 Int) (var6 Heap)) (or (not (and (inv_main618_3 var6 var5) (and (not (= nullAddr var4)) (and (and (and (= var3 (newHeap (alloc var6 (O_node var2)))) (= var1 var5)) (= var0 var5)) (= var4 (newAddr (alloc var6 (O_node var2)))))))) (inv_main var3 var1 var0 var4))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Int) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Int) (var8 Int) (var9 Heap)) (or (not (and (inv_main_13 var9 var8 var7 var6 var5) (and (and (is-O_node (read var9 var5)) (is-O_node (read var9 var5))) (and (and (and (and (= var4 (write var9 var5 (O_node (node (|node::next| (getnode (read var9 var5))) var6)))) (= var3 var8)) (= var2 var7)) (= var1 var6)) (= var0 var5))))) (inv_main619_3 var4 var3 var0 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Int) (var4 Heap)) (or (not (and (inv_main619_3 var4 var3 var2 var1) (and (is-O_node (read var4 var1)) (= var0 (|node::prev| (getnode (read var4 var1))))))) (inv_main586_3 var4 var3 var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Heap)) (not (and (inv_main619_3 var3 var2 var1 var0) (not (is-O_node (read var3 var0)))))))

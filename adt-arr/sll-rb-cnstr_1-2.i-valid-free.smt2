...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (inv_main_30 var9 var8 var7) (and (and (and (and (= var6 var5) (= var4 var3)) (= var2 var1)) (= var0 (|TSLL::next| (getTSLL (read var5 var1))))) (and (and (= var5 (write var9 var8 defObj)) (= var3 var8)) (= var1 var7))))) (inv_main_32 var6 var0 var2))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_17 var6 var5 var4) (and (and (and (and (and (= var3 var6) (= var2 var5)) (= var1 var4)) (= var0 (|TSLL::next| (getTSLL (read var6 var4))))) (not (= (|TSLL::next| (getTSLL (read var6 var4))) nullAddr))) (and (not (= 0 (|TSLL::colour| (getTSLL (read var6 var4))))) (not (= nullAddr var4)))))) (inv_main_17 var3 var2 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Addr) (var10 Heap) (var11 Heap) (var12 Addr) (var13 Addr) (var14 Heap)) (or (not (and (inv_main_17 var14 var13 var12) (and (and (and (and (and (= var11 var10) (= var9 var8)) (= var7 var6)) (= var5 (|TSLL::next| (getTSLL (read var10 var6))))) (not (= (|TSLL::next| (getTSLL (read var10 var6))) nullAddr))) (and (and (and (and (= var10 var4) (= var8 var3)) (= var2 var1)) (= var6 (|TSLL::next| (getTSLL (read var4 var1))))) (and (and (and (and (= var4 var14) (= var3 var13)) (= var0 var12)) (= var1 (|TSLL::next| (getTSLL (read var14 var12))))) (and (= 0 (|TSLL::colour| (getTSLL (read var14 var12)))) (not (= nullAddr var12)))))))) (inv_main_17 var11 var9 var5))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_20 var6 var5 var4) (and (and (and (and (= var3 var6) (= var2 var5)) (= var1 var4)) (= var0 (|TSLL::next| (getTSLL (read var6 var5))))) (and (not (= 0 (|TSLL::colour| (getTSLL (read var6 var5))))) (not (= nullAddr var5)))))) (inv_main_33 var3 var2 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main_32 var3 var2 var1) (= var0 (write var3 var1 defObj)))) (inv_main_20 var0 var2 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main_33 var5 var4 var3) (and (and (= var2 (write var5 var4 defObj)) (= var1 var4)) (= var0 var3)))) (inv_main_20 var2 var0 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_20 var6 var5 var4) (and (and (and (and (= var3 var6) (= var2 var5)) (= var1 var4)) (= var0 (|TSLL::next| (getTSLL (read var6 var5))))) (and (= 0 (|TSLL::colour| (getTSLL (read var6 var5)))) (not (= nullAddr var5)))))) (inv_main_30 var3 var2 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main_30 var2 var1 var0) (and (not (= var1 nullAddr)) (= (read var2 var1) defObj))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main_32 var2 var1 var0) (and (not (= var0 nullAddr)) (= (read var2 var0) defObj))))))

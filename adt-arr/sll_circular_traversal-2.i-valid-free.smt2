...
(declare-fun inv_main614_5 (Heap Int Int Addr Int Addr Addr) Bool)
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Addr) (var4 Int) (var5 Addr) (var6 Int) (var7 Int) (var8 Int) (var9 Heap) (var10 Addr) (var11 Addr) (var12 Heap) (var13 Int) (var14 Int) (var15 Addr) (var16 Int) (var17 Addr) (var18 Int) (var19 Int) (var20 Heap)) (or (not (and (inv_main600_3 var20 var19 var18 var17 var16 var15) (and (and (and (= (+ (+ var14 1) (* (- 1) var13)) (|node::data| (getnode (read var12 var11)))) (and (= var11 var10) (and (and (and (and (and (and (and (and (= var12 var9) (= var13 var8)) (= var7 var6)) (= var10 var5)) (= var14 var4)) (= var3 var2)) (= var11 (|node::next| (getnode (read var9 var2))))) (= var18 (|node::data| (getnode (read var20 var15))))) (and (and (and (and (and (= var9 (write var20 var15 (O_node (node (|node::next| (getnode (read var20 var15))) var16)))) (= var8 var19)) (= var6 var18)) (= var5 var17)) (= var4 var16)) (= var2 var15))))) (= var1 (+ (+ var14 1) (* (- 1) var13)))) (= var0 (|node::next| (getnode (read var12 var11))))))) (inv_main614_5 var12 var13 var7 var10 var1 var11 var0))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Addr) (var4 Int) (var5 Int) (var6 Addr) (var7 Heap) (var8 Int) (var9 Addr) (var10 Addr) (var11 Int) (var12 Addr) (var13 Int) (var14 Int) (var15 Heap)) (or (not (and (inv_main614_5 var15 var14 var13 var12 var11 var10 var9) (and (and (and (= (+ var8 1) (|node::data| (getnode (read var7 var6)))) (and (not (= var6 nullAddr)) (and (and (and (and (and (and (= var7 (write var15 var10 defObj)) (= var5 var14)) (= var4 var13)) (= var3 var12)) (= var8 var11)) (= var2 var10)) (= var6 var9)))) (= var1 (+ var8 1))) (= var0 (|node::next| (getnode (read var7 var6))))))) (inv_main614_5 var7 var5 var4 var3 var1 var6 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Addr) (var4 Int) (var5 Int) (var6 Heap)) (not (and (inv_main614_5 var6 var5 var4 var3 var2 var1 var0) (and (not (= var1 nullAddr)) (= (read var6 var1) defObj))))))
(check-sat)

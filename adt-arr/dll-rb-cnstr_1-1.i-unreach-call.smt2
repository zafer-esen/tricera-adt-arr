...
(declare-fun inv_main1034_12 (Heap Addr Addr) Bool)
(declare-fun inv_main1035_12 (Heap Addr Addr) Bool)
(declare-fun inv_main1036_12 (Heap Addr Addr) Bool)
(declare-fun inv_main1043_11 (Heap Addr Addr) Bool)
(declare-fun inv_main1044_11 (Heap Addr Addr) Bool)
(declare-fun inv_main1050_13 (Heap Addr Addr) Bool)
(declare-fun inv_main1051_13 (Heap Addr Addr) Bool)
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_29 var6 var5 var4) (and (not (= 1 (|TSLL::colour| (getTSLL (read var3 var2))))) (and (not (= nullAddr var2)) (and (and (and (and (= var3 var6) (= var1 var5)) (= var0 var4)) (= var2 (|TSLL::next| (getTSLL (read var6 var4))))) (and (= 0 (|TSLL::colour| (getTSLL (read var6 var4)))) (not (= nullAddr var4)))))))) (inv_main1051_13 var3 var1 var2))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_29 var6 var5 var4) (and (= nullAddr var3) (and (and (and (and (= var2 var6) (= var1 var5)) (= var0 var4)) (= var3 (|TSLL::next| (getTSLL (read var6 var4))))) (and (= 0 (|TSLL::colour| (getTSLL (read var6 var4)))) (not (= nullAddr var4))))))) (inv_main1050_13 var2 var1 var3))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main_10 var2 var1 var0) (not (= 1 (|TSLL::colour| (getTSLL (read var2 var0))))))) (inv_main1034_12 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Heap) (var2 Int) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main1010_2 var6 var5 var4) (and (= nullAddr var3) (and (= var2 0) (and (and (= var1 var6) (= var3 var5)) (= var0 nullAddr)))))) (inv_main1043_11 var1 var3 var3))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main_10 var2 var1 var0) (and (not (= nullAddr (|TSLL::next| (getTSLL (read var2 var0))))) (= 1 (|TSLL::colour| (getTSLL (read var2 var0))))))) (inv_main1035_12 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main1010_2 var6 var5 var4) (and (not (= 1 (|TSLL::colour| (getTSLL (read var3 var2))))) (and (not (= nullAddr var2)) (and (= var1 0) (and (and (= var3 var6) (= var2 var5)) (= var0 nullAddr))))))) (inv_main1044_11 var3 var2 var2))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Addr) (var10 Heap) (var11 Heap) (var12 Addr) (var13 Addr) (var14 Heap)) (or (not (and (inv_main_32 var14 var13 var12) (and (and (and (and (and (and (= var11 var10) (= var9 var8)) (= var7 var6)) (= var5 (|TSLL::next| (getTSLL (read var10 var6))))) (and (and (and (and (= var4 var14) (= var3 var13)) (= var2 var12)) (= var1 (|TSLL::next| (getTSLL (read var14 var13))))) (and (= 0 (|TSLL::colour| (getTSLL (read var14 var13)))) (not (= nullAddr var13))))) (and (and (= var10 (write var4 var3 defObj)) (= var8 var3)) (= var6 var1))) (= var0 (write var11 var7 defObj))))) (inv_main_32 var0 var5 var7))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (inv_main_32 var9 var8 var7) (and (and (and (and (and (= var6 var9) (= var5 var8)) (= var4 var7)) (= var3 (|TSLL::next| (getTSLL (read var9 var8))))) (and (not (= 0 (|TSLL::colour| (getTSLL (read var9 var8))))) (not (= nullAddr var8)))) (and (and (= var2 (write var6 var5 defObj)) (= var1 var5)) (= var0 var3))))) (inv_main_32 var2 var0 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main_10 var2 var1 var0) (and (= nullAddr var0) (and (= nullAddr (|TSLL::next| (getTSLL (read var2 var0)))) (= 1 (|TSLL::colour| (getTSLL (read var2 var0)))))))) (inv_main1036_12 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main_10 var2 var1 var0) (and (not (= nullAddr var0)) (and (= nullAddr (|TSLL::next| (getTSLL (read var2 var0)))) (= 1 (|TSLL::colour| (getTSLL (read var2 var0)))))))) (inv_main1010_2 var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (inv_main1034_12 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (inv_main1035_12 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (inv_main1036_12 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (inv_main1043_11 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (inv_main1044_11 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (inv_main1050_13 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (inv_main1051_13 var2 var1 var0))))
(check-sat)

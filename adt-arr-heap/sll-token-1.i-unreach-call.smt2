...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_14 var6 var5 var4) (and (not (= 2 (|TSLL::data| (getTSLL (read var3 var2))))) (and (and (and (and (= var3 var6) (= var1 var5)) (= var0 var4)) (= var2 (|TSLL::next| (getTSLL (read var6 var4))))) (and (= 2 (|TSLL::data| (getTSLL (read var6 var4)))) (= 1 (|TSLL::data| (getTSLL (read var6 var4))))))))) (inv_main1033_11 var3 var1 var2))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (inv_main_14 var2 var1 var0) (and (not (= 2 (|TSLL::data| (getTSLL (read var2 var0))))) (= 1 (|TSLL::data| (getTSLL (read var2 var0))))))) (inv_main1031_11 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main_14 var6 var5 var4) (and (= 2 (|TSLL::data| (getTSLL (read var3 var2)))) (and (and (and (and (= var3 var6) (= var1 var5)) (= var0 var4)) (= var2 (|TSLL::next| (getTSLL (read var6 var4))))) (and (= 2 (|TSLL::data| (getTSLL (read var6 var4)))) (= 1 (|TSLL::data| (getTSLL (read var6 var4))))))))) (inv_main_29 var3 var1 var1))))

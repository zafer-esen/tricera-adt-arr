...
(declare-fun inv_main547_9_18 (Heap Addr Addr Addr) Bool)
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main_14 var8 var7 var6 var5) (and (and (not (= var4 1)) (and (and (and (and (= var3 var8) (= var2 var7)) (= var1 var6)) (= var0 var5)) (= var4 (|node::h| (getnode (read var8 var5)))))) (not (= var5 nullAddr))))) (inv_main547_9_18 var3 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Heap) (var8 Int) (var9 Addr) (var10 Addr) (var11 Addr) (var12 Heap)) (or (not (and (inv_main535_3 var12 var11 var10 var9) (and (and (= var8 0) (and (and (and (= var7 (write var12 var9 (O_node (node 1 (|node::n| (getnode (read var12 var9))))))) (= var6 var11)) (= var5 var10)) (= var4 var9))) (and (and (and (= var3 (write var7 var4 (O_node (node (|node::h| (getnode (read var7 var4))) 0)))) (= var2 var6)) (= var1 var5)) (= var0 var4))))) (inv_main_14 var3 var2 var1 var2))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap) (var9 Heap) (var10 Addr) (var11 Addr) (var12 Addr) (var13 Heap)) (or (not (and (inv_main_14 var13 var12 var11 var10) (and (and (and (and (and (= var9 var8) (= var7 var6)) (= var5 var4)) (= var3 var2)) (= var1 (|node::n| (getnode (read var8 var2))))) (and (and (= var0 1) (and (and (and (and (= var8 var13) (= var6 var12)) (= var4 var11)) (= var2 var10)) (= var0 (|node::h| (getnode (read var13 var10)))))) (not (= var10 nullAddr)))))) (inv_main_14 var9 var7 var5 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (inv_main547_9_18 var3 var2 var1 var0))))
(check-sat)
